...
export default function App(){
  ...
  return(
    <div style={{minHeight:"100vh",background:"linear-gradient(135deg,#070d1a 0%,#0f172a 60%,#070d1a 100%)",fontFamily:"'DM Sans','Noto Sans JP',system-ui,sans-serif",color:"#e2e8f0",paddingBottom:60}}>
      <style>{`@import url('https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600;700&family=Noto+Sans+JP:wght@400;500;700&display=swap');@keyframes spin{to{transform:rotate(360deg)}}*{box-sizing:border-box}`}</style>

      <div style={{borderBottom:"1px solid rgba(255,255,255,0.05)",padding:"18px 24px 0",background:"rgba(10,15,30,0.7)",backdropFilter:"blur(16px)",position:"sticky",top:0,zIndex:10}}>
        <div style={{maxWidth:800,margin:"0 auto"}}>
          <div style={{display:"flex",alignItems:"baseline",gap:10,marginBottom:18}}>
            <h1 style={{fontSize:17,fontWeight:700,color:"#f1f5f9",margin:0,letterSpacing:"-0.03em"}}>求人適性判定</h1>
        ...
        {view==="input"&&(
          <div>
            <div style={{marginBottom:18}}>
              <h2 style={{fontSize:19,fontWeight:700,color:"#f1f5f9",margin:"0 0 7px",letterSpacing:"-0.02em"}}>求人票をコピペして判定</h2>
